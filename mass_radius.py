...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 26 21:44:08 2024
...
file = "./MESA-Web_Job_09252433814/trimmed_history.data"
output = read_history(file)
mass = output["star_mass"]
log_radius = output['log_R']
radius = 10**(log_radius)


plt.figure(figsize=(8,6))
plt.xlim(0, 29.5)
plt.plot(radius, mass, label="MESA-Web Data", color='blue')

# Labels and legend
plt.xlabel(r'Radius (RSun)')
plt.ylabel(r'Mass (MSun)')
plt.title(r'Mass vs Radius Profile of 1$M_☉$ Star at 4.5*10$^{9}$ Years')
plt.legend()
